...
public class WSPersonServiceServiceLocator extends org.apache.axis.client.Service implements com.ibm.itim.ws.services.WSPersonServiceService {
	...
	static String ISIM_URL;
	  private java.lang.String WSPersonService_address =	ISIM_URL+"services/WSPersonServiceService";
    public WSPersonServiceServiceLocator()  {
    	try {
    		Properties env=ReadProperties.getProperties();
    		    	
    		         ISIM_URL = env.getProperty("isimurl");
    		        System.out.println("isimurl person service"+ISIM_URL);
    		        WSPersonService_address=ISIM_URL+"services/WSPersonServiceService";
    		        System.out.println("WS Person address:"+WSPersonService_address);
    		    	}
    		    	catch (Exception e) {
